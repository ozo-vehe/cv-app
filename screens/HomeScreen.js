    ...
    <View style={homeStyles.container}>
      <View style={homeStyles.profileContainer}>
        <View style={homeStyles.profile}>
          ...
          <Text style={homeStyles.details}>Slack Username: {defaultSlack}</Text>
